 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
 ...
 #else 
  #define HSE_VALUE    ((uint32_t)12000000) /*8000000,Modified by QWB 2013.10.12!< Value of the External oscillator in Hz */
 #endif /* STM32F10X_CL */
#endif /* HSE_VALUE */
...
#define SRAM_BLOCK_LEN        ((uint32_t)0x00007FFF) /*!< SRAM block length*/
