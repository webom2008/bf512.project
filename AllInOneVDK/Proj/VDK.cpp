...
namespace VDK
{
    ...
    {
        INIT_THREADTEMPLATE_("kBootThread",kPriority5, 255,  ::BootThread::Create  ,ksystem_heap ,ksystem_heap,false),
        INIT_THREADTEMPLATE_("kLedThread",kPriority5, 255,  ::LedThread::Create  ,ksystem_heap ,ksystem_heap,false)
    };
...
HeapID g_IOObjectHeap = ksystem_heap;
    ...
    float g_ClockFrequency = 256000.000;

    unsigned int g_ClockPeriod = 25600;
    ...
    {
        { kLedThreadInitDone, 0, 2147483647, 0, 0 }
    };
