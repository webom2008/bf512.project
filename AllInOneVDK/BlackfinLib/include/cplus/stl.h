...
public:
	...
	explicit Deque(typename deque<_Ty, allocator<_Ty> >::size_type _Count)
		: deque<_Ty, _Alloc>(_Count, _Ty())
		{	// construct deque from _Count * _Ty()
		}

	Deque(typename deque<_Ty, allocator<_Ty> >::size_type _Count, const _Ty& _Val)
		: deque<_Ty, _Alloc>(_Count, _Val)
		{	// construct deque from _Count * _Val
		}

	typedef typename deque<_Ty, allocator<_Ty> >::const_iterator _Iter;
...
public:
	...
	explicit List(typename list<_Ty, allocator<_Ty> >::size_type _Count)
		: list<_Ty, _Alloc>(_Count, _Ty())
		{	// construct list from _Count * _Ty()
		}

	List(typename list<_Ty, allocator<_Ty> >::size_type _Count, const _Ty& _Val)
		: list<_Ty, _Alloc>(_Count, _Val)
		{	// construct list from _Count * _Val
		}

	typedef typename list<_Ty, allocator<_Ty> >::const_iterator _Iter;
...
public:
	...
	typedef typename map<_Kty, _Ty, _Pr, allocator<_Ty> >::const_iterator _Iter;
...
public:
	...
	typedef typename multimap<_Kty, _Ty, _Pr, allocator<_Ty> >::const_iterator _Iter;
...
public:
	...
	typedef typename set<_Kty, _Pr, allocator<_Kty> >::const_iterator _Iter;
...
public:
	...
	typedef typename multiset<_Kty, _Pr, allocator<_Kty> >::const_iterator _Iter;
...
public:
	...
	explicit Vector(typename vector<_Ty, allocator<_Ty> >::size_type _Count)
		: vector<_Ty, _Alloc>(_Count, _Ty())
		{	// construct vector from _Count * _Ty()
		}

	Vector(typename vector<_Ty, allocator<_Ty> >::size_type _Count, const _Ty& _Val)
		: vector<_Ty, _Alloc>(_Count, _Val)
		{	// construct vector from _Count * _Val
		}

	typedef typename vector<_Ty, allocator<_Ty> >::const_iterator _Iter;
...
public:
	...
	explicit bit_vector(typename vector<_Bool>::size_type _Count, const _Ty& _Val = _Ty())
		: vector<_Bool, _Bool_allocator>(_Count, _Val)
		{	// construct vector from _Count * _Val
		}

	typedef typename vector<_Bool>::const_iterator _Iter;
