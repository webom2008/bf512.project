...
#pragma file_attr(  "libFunc=PRIMITIVE_WRITE2")
#pragma file_attr(  "libFunc=_PRIMITIVE_WRITE2")
...
int
PRIMITIVE_WRITE2(int fileID, unsigned char* buf, size_t n)
{
