...
#define OS_MAX_EVENTS            80    /* Max. number of event control blocks in your application      */
...
#define OS_MAX_TASKS             48    /* Max. number of tasks in your application, MUST be >= 2       */

#define OS_SCHED_LOCK_EN          1    /*     Include code for OSSchedLock() and OSSchedUnlock()       */

#define OS_TICK_STEP_EN           1    /* Enable tick stepping feature for uC/OS-View                  */
#define OS_TICKS_PER_SEC   (1000000u/1000u)
                                        /* Set the number of ticks in one second                       */


                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE   2000    /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE  2000    /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE  2000    /* Idle       task stack size (# of OS_STK wide entries)        */
...
#define OS_TMR_CFG_NAME_SIZE     32    /*     Determine the size of a timer name                         */
