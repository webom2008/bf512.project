...
static volatile u32 *PortMuxRegs[] = {
    pPORTA_MUX,     /* Port A Multiplexer Control Register */
    pPORTB_MUX,     /* Port B Multiplexer Control Register */
    pPORTC_MUX,     /* Port C Multiplexer Control Register */
    pPORTD_MUX,     /* Port D Multiplexer Control Register */
    pPORTE_MUX,     /* Port E Multiplexer Control Register */
    ...
    pPORTI_MUX,     /* Port I Multiplexer Control Register */
    pPORTJ_MUX      /* Port J Multiplexer Control Register */
};

/* PORTx_FER register addresses */
static volatile u16 *PortFerRegs[] = {
    pPORTA_FER,     /* Port A Function Enable Register      */
    pPORTB_FER,     /* Port B Function Enable Register      */
    pPORTC_FER,     /* Port C Function Enable Register      */
    pPORTD_FER,     /* Port D Function Enable Register      */
    pPORTE_FER,     /* Port E Function Enable Register      */
    ...
    pPORTI_FER,     /* Port I Function Enable Register      */
    pPORTJ_FER      /* Port J Function Enable Register      */
};
