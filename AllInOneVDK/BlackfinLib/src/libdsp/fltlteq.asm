...
** floating-point less than or equal comparison. This function is
...
%rtl "12fcmp <="
%notes "Single-precision floating-point less-than-or-equal-to comparison."
%regs_clobbered "R0-R3,P1,CCset"
%const
%return_in_cc
%syscall ___float32_adi_lteq(I=FF)
#endif
