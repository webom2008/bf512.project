 ...
 *****************************************************************************/
    ...
    Function: cfftf_fr32 - fast N-point complex input FFT

    Synopsis:

        #include <filter.h>
        void cfftf_fr32 (const complex_fract32 input[], 
    ...
    Description:
        ...
        This function transforms the time domain complex input signal to
        the frequency domain by using the accelerated version of the Discrete
        Fourier Transform known as a Fast Fourier Transform or FFT. The
        cfftf_fr32 function decimates in frequency using a mixed-radix
        algorithm. 
    ...
    Error Conditions:
        ...
        The cfftf_fr32 function returns if the FFT size is less than 8
    ...
    Example:
        ...
        cfftf_fr32 (in1, out1, twiddle, 
                    FFT_SIZE2/FFT_SIZE1, FFT_SIZE1); 

        cfftf_fr32 (in2, out2, twiddle,
                    1, FFT_SIZE2);
...
.FILE_ATTR libFunc       = __cfftf_fr32;
.FILE_ATTR libFunc       = cfftf_fr32;
.FILE_ATTR FuncName      = __cfftf_fr32;

/* Called by rfftf_fr32 */
.FILE_ATTR libFunc  = rfftf_fr32;
.FILE_ATTR libFunc  = __rfftf_fr32;
.FILE_ATTR FuncName = __rfftf_fr32;

/* Called by cfft2d_fr32 */
.FILE_ATTR libFunc  = cfft2d_fr32;
.FILE_ATTR libFunc  = __cfft2d_fr32;
.FILE_ATTR FuncName = __cfft2d_fr32;
...
.bitrev_start:
         ...
         R2 = R2 + R7, R7 = R2 - R7 (S) || R0 = [P1++]   || [I0++] = R1; 
         R6 = R3 + R6, R3 = R3 - R6 (S) || R1 = [P1++P2] || [I0++] = R2;
         R0 = R0 >>> 1                  || R2 = [P1++]   || [I0++] = R3;
...
.bitrev_end:
      ...
      R0 = R0 + R4, R4 = R0 - R4 (S);
      R1 = R1 + R5, R5 = R1 - R5 (S) || [I0++] = R0; 
      R2 = R2 + R7, R7 = R2 - R7 (S) || [I0++] = R1; 
      R6 = R3 + R6, R3 = R3 - R6 (S) || [I0++] = R2; 
...
.loop_groups_start:
            ...
            R7 >>>= 1;
            R0 = R0 + R4, R4 = R0 - R4 (S);
            R2 = R2 + R7, R7 = R2 - R7 (S) || [I0++M0] = R0 || I1 += 4;
            R2 = R1 >>> 1                  || [I0++M0] = R2 || R1 = [I1--];  
            R3 = R3 >>> 1                  || [I0++M0] = R4 || I1 -= 4;  
            R5 = R5 >>> 1                  || [I0++] = R7;

            R4 = R3 + R6, R3 = R3 - R6 (S) || R7 = [I3--]   || I0 += 4;
...
.last_radix2_start:
         ...
         A1  = R5.H * R0.L (M), A0  = R5.H * R0.H (IS) || [I0++] = R3; 
         A1 += R0.H * R5.L (M)                         || [I2++] = R2
                                                       || R3 = [I0];
         A1 += R1.H * R4.L (M), A0 += R1.H * R4.H (IS);
         A1 += R4.H * R1.L (M);
         A1 = A1 >>> 16                                || R4 = [I3++];
         R2 = (A0 += A1)                               || R5 = [I3--];
         R3 >>>= 1;
