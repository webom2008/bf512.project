 ...
 *****************************************************************************/
    ...
    Function: twidfft_fr16 - twiddle factor generator
    ...
    Description:
        ...
        The twidfft_fr16 function generates complex twiddle factors
        for the radix-4 FFT functions cfftrad4_fr16, ifftrad4_fr16,
        and rfftrad4_fr16 and returns the coefficients in the vector
        twiddle_table. The coefficients are pairs of sine and cosine
        values that are used by the FFT functions to calculate a Fast
        Fourier Transfer. The vector is known as a twiddle table and
        its size must be at least 3*fft_size/4 where fft_size is the
        ...
        the largest FFT that the application expects to generate. Each
        of the radix-4 FFT functions cfftrad4_fr16, ifftrad4_fr16, and
        rfftrad4_fr16 have a twiddle stride argument that the application
        ...
        Note: The twidfft_fr16 function and the radix-4 FFT functions
    ...
    Error Conditions:
        ...
        The twidfft_fr16 function does not return an error condition.
    ...
    Example:
        ...
        twidfft_fr16 (twiddles, FFT_SIZE1);
...
#pragma file_attr ("libFunc  =twidfft_fr16")
#pragma file_attr ("libFunc  =__twidfft_fr16")
...
extern void
twidfft_fr16( complex_fract16 _twiddle_table[],
              int             _fft_size )
{
