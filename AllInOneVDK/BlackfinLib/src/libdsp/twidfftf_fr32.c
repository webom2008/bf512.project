 ...
 *****************************************************************************/
    ...
    Function: twidfftf_fr32 - twiddle factor generator for optimized FFTs
    ...
    Description:
        ...
        The twidfftf_fr32 function calculates complex twiddle coefficients
        ...
        must be at least 3/4 * fft_size. It contains pairs of sine and cosine
        ...
        of the functions cfftf_fr32, ifftf_fr32, and rfftf_fr32.
        ...
        the application expects to generate. Each of the functions cfftf,
        ifftf, and rfftf have a twiddle stride argument that the application
    ...
    Error Conditions:
        ...
        The twidfftf_fr32 function does not return an error condition.
    ...
    Example:
        ...
        cfftf_fr32 (input1, output1, twiddles, 
                    1, FFT_SIZE1);

        cfftf_fr32 (input2, output2, twiddles, 
...
extern void
twidfftf_fr32( complex_fract32 _twiddle_table[],
               int             _fft_size )
{
    ...
    */
    ...
    twiddle_table[idx_q3].re = (fract32) 0x80000000;  /* = cos( PI ) */
    twiddle_table[idx_q3].im = (fract32) 0x0;         /* = sin( PI ) */
