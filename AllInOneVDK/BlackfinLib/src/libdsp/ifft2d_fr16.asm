...
******************************************************************************
  ...
  Description    : 2D Inverse Fast Fourier Transform
                        ...
                        void ifft2d_fr16 (const complex_fract16 in[], 
                                                complex_fract16 t[], 
                                                complex_fract16 out[], 
...
.file_attr libFunc  = __ifft2d_fr16;
...
__ifft2d_fr16:
       ...
       R0 = [I0++];                    //Load first input value
       I2 = B2;                        //Set I2 to &temp. buffer
       R1 = R0 >>> 2 (V);

       /* Copy data, swapping real and imaginary part, and scale */
...
Last_n1_end: 
       ...
       /* Bit reversal, undo swap operation real / imaginary part */
