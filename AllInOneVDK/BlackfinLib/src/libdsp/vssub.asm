...
******************************************************************************
  ...
  Label name     :  __vecssub_fr16
  Description    : This function computes the scalar difference between
...
.file_attr libFunc       = vecssub_fr16;
.file_attr libFunc       = __vecssub_fr16;
.file_attr libFunc       = matssub_fr16;        // called from matrix.h
...
__vecssub_fr16:
        ...
        LSETUP(ST_VSSUB,ST_VSSUB) LC0 = P1;
            // DO SUBTRACTION, FETCH NEXT INPUT, STORE PREVIOUS OUTPUT 
ST_VSSUB:   R3.L = R0.L - R1.L(S) || R0 = W[P0++] (Z) || W[I0++] = R3.L;
