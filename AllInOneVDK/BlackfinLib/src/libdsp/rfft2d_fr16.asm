/******************************************************************************
  ...
  All rights reserved
******************************************************************************
  File Name      : rfft2d_fr16.asm
  Include File   : filter.h
  Label name     : __rfft2d_fr16

  Description    : 2D Real Fast Fourier Transform
                   ...
                   well (provided the size of the array in is doubled).
...
.file_attr libFunc       = __rfft2d_fr16;
.file_attr libName       = libdsp;
.file_attr prefersMem    = internal;
.file_attr prefersMemNum = "30";
.file_attr FuncName      = __rfft2d_fr16;

.section program;
.global  __rfft2d_fr16;
...
__rfft2d_fr16:
       ...
       P4 = B0;                        //Pointer to input array
       P5 = B2;                        //Pointer to temporary array 
       B3 = R0;                        //Pointer to twiddle table

       SP += -36;
       [SP+4] = P1;                    //Preserve size fft
       [SP+24] = R2;                   //Preserve address of output data
       ...
       /* Populate temporary buffer -
          Proces the input array back to front 
          (otherwise in-place operation would fail due to corrupted memory)
        */

       R0 = R0.L * R0.L (IS);          //R0 = size fft * size fft
       P2 = R0;                        //Set loop couter
       ...
       R0 = W[P4--] (Z);               //Load first input value
