...
**
** int __float64_adi_lt(long double X, long double Y)
**
...
%rtl "12fcmp <"
%notes "Double-precision floating-point less-than comparison."
%regs_clobbered "R0-R3,P0-P2,CCset"
%const
%return_in_cc
%syscall ___float64_adi_lt(I=lDlD)
#endif
...
.file_attr libFunc = ___float64_adi_lt;
.file_attr FuncName      = ___float64_adi_lt;
#endif
...
___float64_adi_lt:
	...
	CC = !CC;				// Invert to get the result of X<Y
...
.___float64_adi_lt.end:
.global ___float64_adi_lt;
