...
%rtl "1fs"
%notes "Converts a single-precision floating-point number to a 64-bit integer."
%syscall ___float32_to_longlong64(lL=F)
#endif
...
.file_attr libFunc = ___float32_to_longlong64;
.file_attr FuncName      = ___float32_to_longlong64;
...
__float32_to_longlong64: /* for backwards compatibility */
___float32_to_longlong64:
	P1 = R0;		// Store for sign, later
...
.___float32_to_longlong64.end:
.global __float32_to_longlong64;
.global ___float32_to_longlong64;
.type __float32_to_longlong64, STT_FUNC;
.type ___float32_to_longlong64, STT_FUNC;
