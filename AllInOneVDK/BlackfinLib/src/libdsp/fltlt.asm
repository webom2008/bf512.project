...
** floating-point less than comparison. This function is for compiler
...
%const
%notes "Single-precision floating-point less-than comparison."
%return_in_cc
%syscall ___float32_adi_lt(I=FF)
#endif
