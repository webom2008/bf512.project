...
/*
 * Description :  This file contains the 64-bit implementation of log10().
...
#pragma file_attr("libFunc  =__log10d")
#pragma file_attr("libFunc  =log10d")
