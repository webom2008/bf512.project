/****************************************************************************
 *
 * cfft2d_fr32.c : $Revision: 1.7.12.1 $
 *
 ...
 ***************************************************************************/
    ...
    Function: cfft2d_fr32 - N x N point 2-D complex Fast Fourier Transform 
    ...
    Description:
        ...
        of the complex input matrix input[fft_size][fft_size] and stores the
    ...
    Error Conditions:
        ...
        The cfft2d_fr32 function aborts if fft_size is less than 8 
    ...
    Implementation:
        ...
        of the cfftf_fr32 and ctranspm_fr32 DSP runtime library functions.
    ...
    Example:
        ...
        cfft2d_fr32 (in1, temp, in1, twiddle, 
                     TWIDDLE_STRIDE1, FFT_SIZE1);

        cfft2d_fr32 (in2, temp, out2, twiddle,
...
#pragma file_attr("libFunc  =cfft2d_fr32")
#pragma file_attr("libFunc  =__cfft2d_fr32")
...
extern void  
cfft2d_fr32 (const complex_fract32  *_input,
...
#pragma loop_count(8,,)
    ...
    for (j = 0; j < rows; j++)
    {
        cfftf_fr32 (&input[j*columns], &temp[j*columns], 
