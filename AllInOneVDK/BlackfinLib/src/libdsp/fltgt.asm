...
** floating-point greater than comparison. This function is for compiler
** internal use only. It does not follow the normal C ABI.
**
** int __float32_adi_gt(float X, float Y)
**
**   X is received in R0.
**   Y is received in R1.
...
%rtl "12fcmp >"
%notes "Single-precision floating-point greater-than comparison."
%regs_clobbered "R0-R3,P1,CCset"
%const
%return_in_cc
%syscall ___float32_adi_gt(I=FF)
#endif
...
.file_attr libFunc       = ___float32_adi_gt;
.file_attr FuncName      = ___float32_adi_gt;
#endif
...
.___float32_adi_gt.end:
.type ___float32_adi_gt, STT_FUNC;
.global ___float32_adi_gt;
