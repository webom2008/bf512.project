 ...
 *****************************************************************************/
    ...
    Description:
        ...
        The cosf function returns the cosine of x. Both the argument x
        and the function result are in radians, and x must be in the
        range [-102940.0, 102940.0].

    Error Conditions:

        The cosf function returns 0.0 if the input is outside the
        defined domain.
    ...
    Example:
        ...
        float  y = cosf (1.0471976F);  /* y = cos(pi/3) = 0.5 */
...
#pragma file_attr("libFunc  =cosf")
#pragma file_attr("libFunc  =__cosf")
...
cosf (float _x)
{
    ...
    const fract_15_49_t pi_coeff[4] = { 
        0x0003243f6a8885a3LL, /* pi   (15.49) */
        0x0001921fb54442d2LL, /* pi/2 (15.49) */
        0x0000c90fdaa22169LL, /* pi   (17.47) */
        0x00006487ed5110b4LL  /* pi/2 (17.47) */ 
    }; 
    ...
    if (expected_true (yabs.fx <= ymax)) 
    {
        ...
        { 
            ...
            */
            ...
            ff -= (((fract_15_49_t) n) * pi_coeff[scale_adj]);

            ff += pi_coeff[scale_adj + 1UL];
