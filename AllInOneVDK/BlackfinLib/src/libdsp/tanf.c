 ...
 *****************************************************************************/
    ...
    Description:
        ...
        The tanf function returns the tangent of x. Both the argument x and
        the function result are in radians. The function is defined for input
        values in the range [-51471, 51471].

    Error Conditions:

        The tanf function returns a zero if the input is not within the
        defined range.
    ...
    Example:
        ...
        float r1 = tanf (PI/4);  /* r1 = tan(pi/4) = 1       */
        float r2 = tanf (PI/6);  /* r2 = tan(pi/6) = 0.57735 */
...
#pragma file_attr("libFunc=__tanf")
#pragma file_attr("libFunc=tanf")
