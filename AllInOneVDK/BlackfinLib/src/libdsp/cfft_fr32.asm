/*****************************************************************************
 *
 * cfft_fr32.asm : $Revision: 1.5.14.2 $
 *
 ...
 *****************************************************************************/
    ...
    Function: cfft_fr32 - Complex radix-2 Fast Fourier Transform
    ...
    Description:
        ...
        This function transforms the time domain complex input signal
    ...
    Error Conditions:
        ...
        The cfft_fr32 function aborts if the FFT size is less than 8
...
.FILE_ATTR libFunc       = __cfft_fr32;
.FILE_ATTR libFunc       = cfft_fr32;
.FILE_ATTR FuncName      = __cfft_fr32;
#endif
