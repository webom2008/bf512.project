...
Title: SSM2603 Audio CODEC driver

Description: This is the primary source file for SSM2603 Audio CODEC driver
...
/* SSM2603 driver includes */
#include <drivers/codec/adi_ssm2603.h>
...
/* Number of SSM2603 devices in the system  */
#define ADI_SSM2603_NUM_DEVICES         (sizeof(gaoSSM2603Device)/sizeof(ADI_SSM2603_DRIVER_DEF))

/* TWI Global Address for SSM2603 when CSB pin is 0  */
#define ADI_SSM2603_CSB_LOW_TWI_ADDR    0x1AU
/* TWI Global Address for SSM2603 when CSB pin is 1  */
#define ADI_SSM2603_CSB_HIGH_TWI_ADDR   0x1BU

/*
** Macros to manipulate SSM2603 hardware register access
*/

/* Number of SSM2603 registers to cache */
#define ADI_SSM2603_NUM_REGS_TO_CACHE   13U
/* Address of the last register in SSM2603 */
#define ADI_SSM2603_FINAL_REG_ADDRESS   0x24FFU
/* SSM2603 Register Address mask */
#define ADI_SSM2603_REG_ADDR_MASK       0xFE00U
/* SSM2603 Register Data mask */
#define ADI_SSM2603_REG_DATA_MASK       0x01FFU
/* Shift Count to reach SSM2603 Register Address */
#define ADI_SSM2603_REG_ADDR_SHIFT      9U
/* Shift count to reach Sampling Rate field in Sampling control register */
#define ADI_SSM2603_SHIFT_SR            2U
...
/*
** Stereo modes supported by SSM2603 hardware
**  SSM2603 driver Auto-SPORT configuration does not support
**  DSP and Right-Justified modes
*/
enum
{
    SSM2603_STEREO_MODE_RJ = 0,
    SSM2603_STEREO_MODE_LJ,
    SSM2603_STEREO_MODE_I2S,
    SSM2603_STEREO_MODE_DSP
};

/*
** List of data word lengths supported by SSM2603
*/
enum
{
    SSM2603_WORD_LENGTH_16BITS = 0x00,
    SSM2603_WORD_LENGTH_20BITS = 0x04,
    SSM2603_WORD_LENGTH_24BITS = 0x08,
    SSM2603_WORD_LENGTH_32BITS = 0x0C
};
...
/*
** Structure to hold SSM2603 Audio Data Interface Port specific information
*/
typedef struct __AdiSSM2603DriverDataPortInfo
{
    ...
    /* SSM2603 device instance number to with this port belongs */
...
} ADI_SSM2603_DRIVER_DATA_PORT_INFO;

/*
** SSM2603 Driver instance structure
*/
typedef struct __AdiSSM2603DriverDef
{
    /* 'true' to use TWI to access device registers, 'false' to use SPI */
    bool                                bUseTwiForRegAccess;

    /* TWI/SPI device number to use to access SSM2603 registers */
    u8                                  nTwiSpiDevNumber;

    /* TWI global address / SPI chipselect for SSM2603 register access */
    u8                                  nTwiGAddrSpiCs;
    ...
    /* SSM2603 hardware registers cache */
    u16                                 anSSM2603Reg[ADI_SSM2603_NUM_REGS_TO_CACHE];
    ...
    ADI_SSM2603_DRIVER_DATA_PORT_INFO   oAudioTx;

    /* Instance to manage audio receive data */
    ADI_SSM2603_DRIVER_DATA_PORT_INFO   oAudioRx;

} ADI_SSM2603_DRIVER_DEF;

/*=============  D A T A  =============*/

/* Create SSM2603 device instance(s) */
static ADI_SSM2603_DRIVER_DEF   gaoSSM2603Device[] =
{
    /* SSM2603 Device 0 */
    {
...
/* Opens SSM2603 for specified data direction */
...
/* Closes a SSM2603 device */
static u32 adi_pdd_Close(
    ADI_DEV_PDD_HANDLE                  hPhysicalDevice
);

/* Queues Inbound buffers to SSM2603 SPORT */
...
/* Queues Outbound buffers to SSM2603 SPORT */
...
/* Sequentially read/writes data to a device
   Function not supported by SSM2603 */
...
/* Function to Access SSM2603 registers */
static u32 adi_ssm2603_RegAccess(
    ADI_SSM2603_DRIVER_DEF              *poDevice,
    u32                                 nCommand,
    void                                *Value
);

/* Writes to a SSM2603 hardware register using Device Access Service */
static u32 adi_ssm2603_DeviceAccess(
    ADI_SSM2603_DRIVER_DEF              *poDevice,
    ADI_DEV_ACCESS_REGISTER             *oAccessSSM2603
);

/* Function to update SSM2603 register cache */
static u32 adi_ssm2603_UpdateDriverCache(
    ADI_SSM2603_DRIVER_DEF              *poDevice,
    ADI_DEV_ACCESS_REGISTER             *oAccessSSM2603
);

/* Updates SSM2603 Sample Control register to match ADC/DAC sampling rate */
static u32 adi_ssm2603_UpdateSampleRate(
    ADI_SSM2603_DRIVER_DEF              *poDevice,
    ADI_SSM2603_SAMPLE_RATE             *poSampleRate
);

/* Function to open a SPORT device */
static u32 adi_ssm2603_SportOpen(
    ADI_SSM2603_DRIVER_DATA_PORT_INFO   *poDataPort
);

/* Function to Configure SPORT registers */
static u32 adi_ssm2603_ConfigSport(
    ADI_SSM2603_DRIVER_DEF              *poDevice,
    ADI_SSM2603_DRIVER_DATA_PORT_INFO   *poDataPort
);

/* Callback function passed to SPORT driver */
static void adi_ssm2603_SportCallback(
    void                                *hCallback,
    u32                                 nEvent,
    void                                *pArgument
);

/* Adjusts SSM2603 Sample Control register value to
   match MCLK frequency */
static u32 adi_ssm2603_AdjustToMclk(
    ADI_SSM2603_DRIVER_DEF              *poDevice,
    u32                                 nMclkFreq
);
...
static u32 adi_ssm2603_ValidateRegAccess(
    ADI_SSM2603_DRIVER_DEF              *poDevice,
    u32                                 nCommandID,
    void                                *Value
);
...
static u32 adi_ssm2603_ValidatePDDHandle(
    ADI_DEV_PDD_HANDLE                  hPhysicalDevice
);
...
ADI_DEV_PDD_ENTRY_POINT     ADISSM2603EntryPoint =
{
    adi_pdd_Open,
    adi_pdd_Close,
    adi_pdd_Read,
...
/*********************************************************************
    ...
    Function: adi_pdd_Open
        ...
        Opens SSM2603 Audio Device for use

    Parameters:
        hDeviceManager     - Device Manager handle
        nDeviceNumber      - SSM2603 device number to open
...
)
{
    ...
    /* Instance to access a SSM2603 register */
    ADI_DEV_ACCESS_REGISTER             oAccessSSM2603;
...
/* for Debug build only - check for errors if required  */
    ...
    if (nDeviceNumber >= ADI_SSM2603_NUM_DEVICES)
    {
    ...
    if (nResult == ADI_DEV_RESULT_SUCCESS)
    {
        ...
        /* SSM2603 device to work on */
        poDevice = &gaoSSM2603Device[nDeviceNumber];
        ...
        if (nResult == ADI_DEV_RESULT_SUCCESS)
        {
            ...
            if (bResetInstance == true)
            {
                ...
                /* By default, use SPI 0 to access SSM2603 registers */
                poDevice->nTwiSpiDevNumber      = 0;
                /* By default, no valid SPI chipselect is available to select SSM2603 */
                ...
                /* Initialise SSM2603 register cache & SPORT register cache to default values */
                /* issue a dummy SSM2603 soft-reset within the driver */
                /* Shift the register address (Bit 15 to Bit 9 in SSM2603 write packet holds the register address to configure) */
                oAccessSSM2603.Address = ((SSM2603_REG_RESET << ADI_SSM2603_REG_ADDR_SHIFT) & ADI_SSM2603_REG_ADDR_MASK);
                /* Bit 8 to Bit 0 in SSM2603 write packet holds the register data (zero to reset SSM2603) */
                /* call update driver cache to reset SSM2603 register cache & SPORT register cache */
                adi_ssm2603_UpdateDriverCache(poDevice,&oAccessSSM2603);
            }
...
/*********************************************************************
    ...
    Function: adi_pdd_Close
        ...
        Closes SSM2603 device

    Parameters:
        hPhysicalDevice - Physical Device handle to SSM2603 device instance
...
)
{
    ...
    ADI_SSM2603_DRIVER_DATA_PORT_INFO   *poDataPort = (ADI_SSM2603_DRIVER_DATA_PORT_INFO *)hPhysicalDevice;

/* for Debug build only - check for errors if required */
#if defined(ADI_DEV_DEBUG)

    /* Validate the given Physical Device Handle */
    nResult = adi_ssm2603_ValidatePDDHandle(hPhysicalDevice);
    ...
    if (nResult == ADI_DEV_RESULT_SUCCESS)
    {
        ...
        if (nResult == ADI_DEV_RESULT_SUCCESS)
        {
            ...
            if (poDataPort->eDirection == ADI_DEV_DIRECTION_BIDIRECTIONAL)
            {
                ...
                gaoSSM2603Device[poDataPort->nAudioDevNumber].oAudioTx.eDirection = ADI_DEV_DIRECTION_UNDEFINED;
                gaoSSM2603Device[poDataPort->nAudioDevNumber].oAudioRx.eDirection = ADI_DEV_DIRECTION_UNDEFINED;
                /* Clear the SPORT device handle */
                gaoSSM2603Device[poDataPort->nAudioDevNumber].oAudioTx.hSport = NULL;
                gaoSSM2603Device[poDataPort->nAudioDevNumber].oAudioRx.hSport = NULL;
            }
...
/* for Debug build only - check for errors if required  */
    ...
    if (nResult == ADI_DEV_RESULT_SUCCESS)
    {
        ...
        nResult = adi_dev_Read(poDataPort->hSport, eBufferType, poRxBuffer);
...
/* for Debug build only - check for errors if required  */
    ...
    if (nResult == ADI_DEV_RESULT_SUCCESS)
    {
        ...
        nResult = adi_dev_Write(poDataPort->hSport, eBufferType, poTxBuffer);
...
/*********************************************************************
    ...
    Sequentially read/writes data to a device
        SSM2603 driver does not support this function
    ...
    Returns:
        ADI_DEV_RESULT_NOT_SUPPORTED
            - Function not supported by SSM2603 driver
...
{
    /* Function is not supported by SSM2603 driver */
...
/*********************************************************************
    ...
    Returns:
        ...
        SPORT/SPI/TWI/SSM2603 Driver specific Error codes
...
)
{
    ...
    ADI_SSM2603_SAMPLE_RATE             oSampleRate;
...
/* for Debug build only - check for errors if required  */
    ...
    if (nResult == ADI_DEV_RESULT_SUCCESS)
    {
        ...
        poDevice = &gaoSSM2603Device[poDataPort->nAudioDevNumber];
        ...
        switch (nCommandID)
        {
                    ...
                    if ((u32)Value == true)
                    {
                            ...
                            (poDevice->oAudioRx.bIsActive == false))
                        {
                            ...
                            */
                            ...
                            /* Register access to update SSM2603 Active Control register */
                            oAccessSSM2603.Address = (SSM2603_REG_ACTIVE_CTRL << ADI_SSM2603_REG_ADDR_SHIFT);
                            /* Update field to activate SSM2603 Digital Audio Interface */
                            oAccessSSM2603.Address |= 1;
                            /* Update SSM2603 Active Control register */
                            nResult = adi_ssm2603_DeviceAccess(poDevice, &oAccessSSM2603);
                        }
                        ...
                        if (nResult == ADI_DEV_RESULT_SUCCESS)
                        {
                            ...
                            nResult = adi_ssm2603_ConfigSport (poDevice, poDataPort);
                        }
            ...
            case ADI_DEV_CMD_GET_PERIPHERAL_DMA_SUPPORT:
                ...
                /* SSM2603 doesn't support DMA, but supports indirectly via SPORT */
                *((u32 *)Value) = false;
                break;
            ...
            case ADI_DEV_CMD_SET_DATAFLOW_METHOD:
                ...
                if (poDataPort->hSport == NULL)
                {
                    ...
                    nResult = adi_ssm2603_SportOpen(poDataPort);
                }
                ...
                if (nResult == ADI_DEV_RESULT_SUCCESS)
                {
                    ...
                    nResult = adi_dev_Control(poDataPort->hSport, nCommandID, Value);
                }
            ...
            ************************/
            ...
            /* CASE: Set SSM2603 driver to use SPI to access SSM2603 hardware registers */
            case ADI_SSM2603_CMD_SET_SPI_DEVICE_NUMBER:
            ...
            /* CASE: Set SPI Chipselect for SSM2603 */
            case ADI_SSM2603_CMD_SET_SPI_CS:
            ...
            ************************/
            ...
            /* CASE: Set SSM2603 driver to use TWI to access SSM2603 hardware registers */
            case ADI_SSM2603_CMD_SET_TWI_DEVICE_NUMBER:
                ...
                if ((poDevice->nTwiGAddrSpiCs != ADI_SSM2603_CSB_LOW_TWI_ADDR) &&\
                    (poDevice->nTwiGAddrSpiCs != ADI_SSM2603_CSB_HIGH_TWI_ADDR))
                {
                    /* Set default TWI Global Address for SSM2603 */
                    poDevice->nTwiGAddrSpiCs = ADI_SSM2603_CSB_LOW_TWI_ADDR;
                }
                break;

            /* CASE: Set TWI Global Address for SSM2603 */
            case ADI_SSM2603_CMD_SET_TWI_GLOBAL_ADDR:

/* for Debug build only - validate TWI Global Address */
#if defined(ADI_DEV_DEBUG)

                /* IF (TWI Global address is invalid) */
                if (((u8)((u32)Value) != ADI_SSM2603_CSB_LOW_TWI_ADDR) &&\
                    ((u8)((u32)Value) != ADI_SSM2603_CSB_HIGH_TWI_ADDR))
                {
                    /* Report Failure (TWI Global address is invalid) */
                    nResult = ADI_SSM2603_RESULT_TWI_GLOBAL_ADDRESS_INVALID;
                    break;
                }

#endif  /* ADI_DEV_DEBUG */

                /* Update TWI Global address for SSM2603 */
                poDevice->nTwiGAddrSpiCs = (u8)((u32)Value);
                break;
            ...
            ****************************/
            ...
            case ADI_SSM2603_CMD_SET_TWI_SPI_CONFIG_TABLE:
            ...
            ************************/
            ...
            case ADI_SSM2603_CMD_SET_SPORT_DEVICE_NUMBER:
...
/* Debug build only - exit on error */
            ...
            /* CASE: Open/Close SPORT device connected to SSM2603 */
            case ADI_SSM2603_CMD_OPEN_SPORT_DEVICE:

                /* IF (Open SPORT device) */
                if ((u32)Value == true)
                {
                    /* IF (SPORT device allocated to SSM2603 is not open yet) */
                    if (poDataPort->hSport == NULL)
                    {
                        /* Open the SPORT device for SSM2603 use */
                        nResult = adi_ssm2603_SportOpen(poDataPort);
                    }
                }
...
/* for Debug build only - exit on error */
            ...
            case ADI_SSM2603_CMD_ENABLE_AUTO_SPORT_CONFIG:
                /* Update Automatic SPORT configuration flag */
                poDataPort->bIsAutoSportConfigEnabled = (u8)((u32)Value);
                break;

            /* CASE: Set SSM2603 Sampling Control register to
                     given ADC and DAC sample rate */
            case ADI_SSM2603_CMD_SET_SAMPLE_RATE:

                /* Update SSM2603 sampling control register */
                nResult = adi_ssm2603_UpdateSampleRate(poDevice, (ADI_SSM2603_SAMPLE_RATE*)Value);

                /* IF (Sample rate is not supported and
                       device not operated in bi-directional mode) */
                if ((nResult == ADI_SSM2603_RESULT_SAMPLE_RATE_NOT_SUPPORTED) &&\
                    (poDataPort->eDirection != ADI_DEV_DIRECTION_BIDIRECTIONAL))
                {
                    ...
                    if (poDataPort->eDirection == ADI_DEV_DIRECTION_OUTBOUND)
                    {
                        ...
                        if (poDevice->oAudioRx.hSport == NULL)
                        {
                            ...
                            oSampleRate.nDacSampleRate = ((ADI_SSM2603_SAMPLE_RATE*)Value)->nDacSampleRate;
                            /* Set Input sample rate same as Output */
                            oSampleRate.nAdcSampleRate = oSampleRate.nDacSampleRate;
                            /* Reset result code */
                            nResult = ADI_DEV_RESULT_SUCCESS;
                        }
                    }
                    ...
                    else
                    {
                        ...
                        if (poDevice->oAudioTx.hSport == NULL)
                        {
                            ...
                            oSampleRate.nAdcSampleRate = ((ADI_SSM2603_SAMPLE_RATE*)Value)->nAdcSampleRate;
                            /* Set Output sample rate same as Input */
                            oSampleRate.nDacSampleRate = oSampleRate.nAdcSampleRate;
                            /* Reset result code */
                            nResult = ADI_DEV_RESULT_SUCCESS;
                        }
                    }
                    ...
                    if (nResult == ADI_DEV_RESULT_SUCCESS)
                    {
                        ...
                        nResult = adi_ssm2603_UpdateSampleRate(poDevice, &oSampleRate);
                    }
                }
                break;

            /* CASE: Pass MCLK (operating) frequency of SSM2603 */
            case ADI_SSM2603_CMD_PASS_MCLK_FREQ:
                /* Update SSM2603 sampling control register fields */
                nResult = adi_ssm2603_AdjustToMclk(poDevice,(u32)Value);
                break;

            /* DEFAULT: other commands */
            default:

                /* pass this Command ID to SSM2603 Register Access Function */
                nResult = adi_ssm2603_RegAccess(poDevice,nCommandID,Value);

                /* IF (Command not supported by SSM2603) */
                if (nResult == ADI_SSM2603_RESULT_CMD_NOT_SUPPORTED)
                {
                    /* IF (Issued command is to control SPORT device) */
                    if ((nCommandID & ADI_SPORT_ENUMERATION_START) == ADI_SPORT_ENUMERATION_START)
                    {
...
/*********************************************************************
    ...
    Function: adi_ssm2603_RegAccess

        Configures SSM2603 hardware registers /
        Reads SSM2603 register values from driver cache
    ...
    Returns:
        ADI_DEV_RESULT_SUCCESS
            - Successfully accessed SSM2603 register(s)
        SPI/TWI/Device Access/SSM2603 Driver specific Error codes
...
/* for Debug build only - Check for errors */
    ...
    nResult = adi_ssm2603_ValidateRegAccess(poDevice,nCommandID,Value);
    ...
    if (nResult == ADI_DEV_RESULT_SUCCESS)
    {
        ...
        switch (nCommandID)
        {
            /* CASE (Read a specific SSM2603 Register) */
            case ADI_DEV_CMD_REGISTER_READ:
            /* CASE (Read a table of SSM2603 registers) */
            case ADI_DEV_CMD_REGISTER_TABLE_READ:
                ...
                while (poSelectiveAccess->Address != ADI_DEV_REGEND)
                {
                    ...
                    if (poSelectiveAccess->Address > SSM2603_REG_RESET)
                    {
                    ...
                    poSelectiveAccess->Data = poDevice->anSSM2603Reg[nCacheIndex];
            ...
            /* CASE (Configure a SSM2603 Resigter) */
            case ADI_DEV_CMD_REGISTER_WRITE:
            /* CASE (Configure a table SSM2603 registers) */
            case ADI_DEV_CMD_REGISTER_TABLE_WRITE:
                ...
                while (poSelectiveAccess->Address != ADI_DEV_REGEND)
                {
                    ...
                    ** SSM2603 register configuration requirements
                    *************************************************/
                    /* Shift the register address
                      (Bit 15 to Bit 9 in SSM2603 write packet holds the
                       register address to configure) */
                    oAccessSSM2603.Address = ((poSelectiveAccess->Address << ADI_SSM2603_REG_ADDR_SHIFT) & ADI_SSM2603_REG_ADDR_MASK);
                    /* Bit 8 to Bit 0 in SSM2603 write packet holds the register data */
                    oAccessSSM2603.Address |= (poSelectiveAccess->Data & ADI_SSM2603_REG_DATA_MASK);

                    /* Pass the new register data to device access service which inturn configures SSM2603 */
                    nResult = adi_ssm2603_DeviceAccess(poDevice,&oAccessSSM2603);
            ...
            /* CASE (Read a specific SSM2603 register field) */
            case ADI_DEV_CMD_REGISTER_FIELD_READ:
            /* CASE (Read a table SSM2603 register(s) field(s)) */
            case ADI_DEV_CMD_REGISTER_FIELD_TABLE_READ:
                ...
                while (poFieldAccess->Address != ADI_DEV_REGEND)
                {
                    ...
                    if (poFieldAccess->Address > SSM2603_REG_RESET)
                    {
                        /* Index to the register in driver cache */
                    ...
                    nFieldData = (poDevice->anSSM2603Reg[nCacheIndex] & poFieldAccess->Field);
            ...
            /* CASE (Configure a specific SSM2603 register field) */
            case ADI_DEV_CMD_REGISTER_FIELD_WRITE:
            /* CASE (Configure a table SSM2603 register(s) field(s)) */
            case ADI_DEV_CMD_REGISTER_FIELD_TABLE_WRITE:
                ...
                while (poFieldAccess->Address != ADI_DEV_REGEND)
                {
                    ...
                    nRegData = poDevice->anSSM2603Reg[nCacheIndex];
                    ...
                    **********************************************/
                    /* Shift the register address
                       (Bit 15 to Bit 9 in SSM2603 write packet holds the
                        register address to configure) */
                    oAccessSSM2603.Address = ((poFieldAccess->Address << ADI_SSM2603_REG_ADDR_SHIFT) & ADI_SSM2603_REG_ADDR_MASK);
                    /* Bit 8 to Bit 0 in SSM2603 write packet holds the register data */
                    oAccessSSM2603.Address |= nRegData;
                    /* Pass the new register data to
                       device access service to configure SSM2603 */
                    nResult = adi_ssm2603_DeviceAccess(poDevice,&oAccessSSM2603);

                    /* IF (Failed to update SSM2603 register(s)) */
                    if (nResult != ADI_DEV_RESULT_SUCCESS)
                    {
                        /* report error */
                        break;
            ...
            /* CASE (Read block of SSM2603 registers starting from first given address) */
            case ADI_DEV_CMD_REGISTER_BLOCK_READ:
                ...
                for (nIndex = 0; nIndex < poBlockAccess->Count ; nIndex++)
                {
                    ...
                    /* copy the register value from driver register cache */
                    *(poBlockAccess->pData+nIndex) = poDevice->anSSM2603Reg[nCacheIndex];

                    /* IF (Last register read == Active Control register) */
                    if (nRegAddr == SSM2603_REG_ACTIVE_CTRL)
                    {
                        /* Reset register is the next register address to configure */
                        nRegAddr = SSM2603_REG_ALC_1;
                    }
                    /* ELSE IF (Register address exceeds the limit) */
                    else if (nRegAddr > SSM2603_REG_NOISE_GATE)
                    {
            ...
            /* CASE (Write to a block of SSM2603 registers starting from first given address) */
                ...
                for (nIndex = 0; nIndex < poBlockAccess->Count ; nIndex++)
                {
                    ...
                    **********************************************/
                    /* Shift the register address
                       (Bit 15 to Bit 9 in SSM2603 write packet holds the
                        register address to configure) */
                    oAccessSSM2603.Address = ((nRegAddr << ADI_SSM2603_REG_ADDR_SHIFT) & ADI_SSM2603_REG_ADDR_MASK);
                    /* Bit 8 to Bit 0 in SSM2603 write packet
                       holds the register data */
                    oAccessSSM2603.Address |= (*(poBlockAccess->pData+nIndex) & ADI_SSM2603_REG_DATA_MASK);
                    /* Pass the new register data to
                       device access service to configures SSM2603 */
                    nResult = adi_ssm2603_DeviceAccess(poDevice,&oAccessSSM2603);
            ...
            default:
                ...
                nResult = ADI_SSM2603_RESULT_CMD_NOT_SUPPORTED;
                break;
...
/*********************************************************************
    ...
    Function: adi_ssm2603_DeviceAccess

        Updates a SSM2603 hardware register using Device Access Service

    Parameters:
        poDevice        - Pointer to SSM2603 device instance to work on
        poAccessSSM2603 - Pointer to register access instance
                          holding info on SSM2603 register to access

    Returns:
        ADI_DEV_RESULT_SUCCESS
            - Successfully accessed SSM2603 register
        SPI/TWI/Device Access/SSM2603 Driver specific Error codes

*********************************************************************/
static u32 adi_ssm2603_DeviceAccess(
    ADI_SSM2603_DRIVER_DEF      *poDevice,
    ADI_DEV_ACCESS_REGISTER     *poAccessSSM2603
)
{
    /* Return code - assume we're going to be successful */
    u32                         nResult = ADI_DEV_RESULT_SUCCESS;
    /* create a device access data instance */
    ADI_DEVICE_ACCESS_REGISTERS oConfigSSM2603;
    /* structure to hold Device type and access type to be used */
    ADI_DEVICE_ACCESS_SELECT    oAccessSelect;
    /* SSM2603 register access info for TWI based register access */
    ADI_DEV_ACCESS_REGISTER     oDevAccessTable;

    /* IF (Client set to use SPI to access SSM2603 registers) */
    if (poDevice->bUseTwiForRegAccess == false)
    {
        /*** This device falls under special case SPI access mode ***/

        /* SPI Chip-select for SSM2603 */
        oAccessSelect.DeviceCS   = poDevice->nTwiGAddrSpiCs;
        /* No SPI Global address for SSM2603 */
        ...
        /* Passing this as 0 sets Device access to consider
           SSM2603 as special case SPI device */
        oAccessSelect.Rdata_len  = ADI_DEVICE_ACCESS_LENGTH0;
        /* Use SPI to configure SSM2603 registers */
        oAccessSelect.AccessType = ADI_DEVICE_ACCESS_TYPE_SPI;

        /*** Populate Device Access instance fields specific to SPI ***/
        /* No SPI Global address for SSM2603    */
        oConfigSSM2603.DeviceAddress = 0;
        /* Command specific value */
        oConfigSSM2603.Value = (void *)poAccessSSM2603;
    }
    /* ELSE (Client has choosen to use TWI to access SSM2603 registers) */
    else
    {
        ...
        /* Use TWI to configure SSM2603 registers */
        oAccessSelect.AccessType = ADI_DEVICE_ACCESS_TYPE_TWI;

        /*** Split the SSM2603 datapacket for TWI access mode ***/
        /* Bits 15:8 passed as address field */
        oDevAccessTable.Address  = (poAccessSSM2603->Address >> 8 & 0xFF);
        /* Bits 7:0 passed as data field */
        oDevAccessTable.Data     = (poAccessSSM2603->Address & 0xFF);

        /*** Populate Device Access instance fields specific to TWI ***/
        /* TWI Address for SSM2603 */
        oConfigSSM2603.DeviceAddress = poDevice->nTwiGAddrSpiCs;
        /* Command specific Value */
        oConfigSSM2603.Value = (void*)&oDevAccessTable;
    }
    ...
    {
        /* Device manager handle */
        oConfigSSM2603.ManagerHandle = poDevice->oAudioTx.hDeviceManager;
        /* handle to the callback manager */
        oConfigSSM2603.DCBHandle     = poDevice->oAudioTx.hDcbManager;
    }
    /* ELSE (Device must be opened for receive mode) */
    else
    {
        /* Device manager handle */
        oConfigSSM2603.ManagerHandle = poDevice->oAudioRx.hDeviceManager;
        /* handle to the callback manager */
        oConfigSSM2603.DCBHandle     = poDevice->oAudioRx.hDcbManager;
    }

    /*** Populate Device access instance ***/

    /* No client handle */
    oConfigSSM2603.ClientHandle         = NULL;
    /* SPI/TWI Device number to use */
    oConfigSSM2603.DeviceNumber         = poDevice->nTwiSpiDevNumber;
    /* No Callback from device access */
    oConfigSSM2603.DeviceFunction       = NULL;
    /* Command ID to configure a register */
    oConfigSSM2603.Command              = ADI_DEV_CMD_REGISTER_WRITE;
    /* Address of the last register SSM2603 (with max data) */
    oConfigSSM2603.FinalRegAddr         = ADI_SSM2603_FINAL_REG_ADDRESS;
    /* No need to check for register field errors */
    oConfigSSM2603.RegisterField        = NULL;
    /* No need to update for reserved bits */
    oConfigSSM2603.ReservedValues       = NULL;
    /* Register address already validated. no need to repeat */
    oConfigSSM2603.ValidateRegister     = NULL;
    /* SPI/TWI configuration table passed by the client */
    oConfigSSM2603.ConfigTable          = poDevice->pSpiTwiConfigTable;
    /* Device Access type */
    oConfigSSM2603.SelectAccess         = &oAccessSelect;
    /* No Additional info */
    oConfigSSM2603.pAdditionalinfo      = (void *)NULL;

    /* Updates driver register cache */
    nResult = adi_ssm2603_UpdateDriverCache(poDevice, poAccessSSM2603);

    /* IF (Updates driver register cache resulted in success) */
    if (nResult == ADI_DEV_RESULT_SUCCESS)
    {
        /* call device access to configure corresponding SSM2603 register */
        nResult = adi_device_access (&oConfigSSM2603);
    }
...
/*********************************************************************
    ...
    Function: adi_ssm2603_UpdateDriverCache

        Updates driver register cache to keep in track of
        SSM2603 hardware register changes

    Parameters:
        poDevice        - Pointer to SSM2603 driver instance to work on
        poAccessSSM2603 - Pointer to register access instance
                          holding info on SSM2603 register to access

    Returns:
        ADI_DEV_RESULT_SUCCESS
            - Successfully updated SSM2603 register cache
...
)
{
    ...
    nRegAddr = (u8) ((poAccessSSM2603->Address & ADI_SSM2603_REG_ADDR_MASK) >> ADI_SSM2603_REG_ADDR_SHIFT);

    /* IF (Configure Reset Register) */
    if (nRegAddr == SSM2603_REG_RESET)
    {
        /* IF (soft-reset SSM2603) */
        if (!(poAccessSSM2603->Address & ADI_SSM2603_REG_DATA_MASK))
        {
            /*
            **Initialise SSM2603 register cache to default values
            */
            /* Left Line In Mute, 0dB */
            poDevice->anSSM2603Reg[SSM2603_REG_LEFT_ADC_VOL]    = 0x0097U;
            /* Right Line In Mute, 0dB */
            poDevice->anSSM2603Reg[SSM2603_REG_RIGHT_ADC_VOL]   = 0x0097U;
            /* Left HP volume = 0dB */
            poDevice->anSSM2603Reg[SSM2603_REG_LEFT_DAC_VOL]    = 0x0079U;
            /* Right HP volume = 0dB */
            poDevice->anSSM2603Reg[SSM2603_REG_RIGHT_DAC_VOL]   = 0x0079U;
            /* Enable Bypass, MIC Mute enabled */
            poDevice->anSSM2603Reg[SSM2603_REG_ANALOGUE_PATH]   = 0x000AU;
            /* Enable DAC Soft mute */
            poDevice->anSSM2603Reg[SSM2603_REG_DIGITAL_PATH]    = 0x0008U;
            /* Power-down all except ClkOut & Oscillator */
            poDevice->anSSM2603Reg[SSM2603_REG_POWER]           = 0x009FU;
            /* I2S mode, 24-bits */
            poDevice->anSSM2603Reg[SSM2603_REG_DIGITAL_IFACE]   = 0x000AU;
            /* Normal mode, 256fs */
            poDevice->anSSM2603Reg[SSM2603_REG_SAMPLING_CTRL]   = 0;
            /* SSM2603 is Not Active */
            poDevice->anSSM2603Reg[SSM2603_REG_ACTIVE_CTRL]     = 0;
            /* SSM2603 Automatic Level Control register 1 */
            poDevice->anSSM2603Reg[SSM2603_REG_ACTIVE_CTRL+1]   = 0x007BU;
            /* SSM2603 Automatic Level Control register 2 */
            poDevice->anSSM2603Reg[SSM2603_REG_ACTIVE_CTRL+2]   = 0x0032U;
            /* SSM2603 Noise Gate register */
            poDevice->anSSM2603Reg[SSM2603_REG_ACTIVE_CTRL+3]   = 0;
    ...
    else if (nRegAddr <= SSM2603_REG_ACTIVE_CTRL)
    {
        /* update driver register cache */
        poDevice->anSSM2603Reg[nRegAddr] = (poAccessSSM2603->Address & ADI_SSM2603_REG_DATA_MASK);

        /* extract SSM2603 audio input format */
        nTemp = (poDevice->anSSM2603Reg[SSM2603_REG_DIGITAL_IFACE] & SSM2603_RFLD_IFACE_FORMAT);
        ...
        */
        ...
        if ((nTemp == SSM2603_STEREO_MODE_LJ) ||\
            (nTemp == SSM2603_STEREO_MODE_I2S))
        {
            ...
            if (nTemp == SSM2603_STEREO_MODE_LJ)
            {
                ...
                if (!(poDevice->anSSM2603Reg[SSM2603_REG_DIGITAL_IFACE] & SSM2603_RFLD_DAC_LR_POLARITY))
                {
                ...
                if (!(poDevice->anSSM2603Reg[SSM2603_REG_DIGITAL_IFACE] & SSM2603_RFLD_BCLK_INVERT))
                {
            ...
            nTemp = (poDevice->anSSM2603Reg[SSM2603_REG_DIGITAL_IFACE] & SSM2603_RFLD_AUDIO_DATA_LEN);

            /* IF (Input Audio Data bit length is set to 16 bits) */
            if (nTemp == SSM2603_WORD_LENGTH_16BITS)
            {
            ...
            else if (nTemp == SSM2603_WORD_LENGTH_20BITS)
            {
            ...
            else if (nTemp == SSM2603_WORD_LENGTH_24BITS)
            {
            ...
            /* IF (SSM2603 set in slave mode) */
            if (!(poDevice->anSSM2603Reg[SSM2603_REG_DIGITAL_IFACE] & SSM2603_RFLD_ENABLE_MASTER))
            {
    ...
    else if ((nRegAddr >= SSM2603_REG_ALC_1) && (nRegAddr <= SSM2603_REG_NOISE_GATE))
    {
        /* update driver register cache */
        poDevice->anSSM2603Reg[nRegAddr-6] = (poAccessSSM2603->Address & ADI_SSM2603_REG_DATA_MASK);
    }
...
/*********************************************************************
    ...
    Function: adi_ssm2603_AdjustToMclk

        Adjusts SSM2603 Sample Control register value to match MCLK frequency
...
{
    /* to manipulate SSM2603 Sampling Rate register value */
    u16                         nRegData;
    /* return code - assume we're going to be successful */
    u32                         nResult = ADI_DEV_RESULT_SUCCESS;
    /* structure to access one SSM2603 register */
    ADI_DEV_ACCESS_REGISTER     oAccessSSM2603;
    ...
    if (nMclkFreq < (sizeof(anSRFieldLut)/sizeof(anSRFieldLut[0])))
    {
        ...
        nRegData &= ~(SSM2603_RFLD_CLKOUT_DIV2 |\
                      SSM2603_RFLD_ENABLE_USB_MODE);

        /* IF (MCLK is other than 12 MHz or 24MHz) */
        if (((ADI_SSM2603_MCLK_FREQ)nMclkFreq != ADI_SSM2603_MCLK_12) &&\
            ((ADI_SSM2603_MCLK_FREQ)nMclkFreq != ADI_SSM2603_MCLK_24))
        {
            /* Clear BOSR field in Sample rate register */
            nRegData &= ~SSM2603_RFLD_BOS_RATE;
        }
        ...
        /* Shift the register address
           (Bit 15 to Bit 9 in SSM2603 write packet holds the
           register address to configure) */
        oAccessSSM2603.Address = ((SSM2603_REG_SAMPLING_CTRL << ADI_SSM2603_REG_ADDR_SHIFT) & ADI_SSM2603_REG_ADDR_MASK);
        /* Bit 8 to Bit 0 in SSM2603 write packet holds the register data */
        oAccessSSM2603.Address |= (nRegData & ADI_SSM2603_REG_DATA_MASK);
        /* Update Sample Rate register value in SSM2603 device and driver cache */
        nResult = adi_ssm2603_UpdateDriverCache(poDevice,&oAccessSSM2603);
    }
    /* ELSE (given MCLK must be invalid) */
    else
    {
        /* report error (MCLK invalid) */
        nResult = ADI_SSM2603_RESULT_MCLK_INVALID;
    }
...
/*********************************************************************
    ...
    Function: adi_ssm2603_UpdateSampleRate

        Updates SSM2603 Sampling rate register to match
...
)
{
    ...
    /* Sampling Rate Look-up Table as provided in SSM2603 spec */
    const static u32 aSamplingRateLut[] =
    {
        /* Normal & USB Mode -> SR = 0, ADC = 48kHz, DAC = 48kHz */
        ADI_SSM2603_SR_48000,
    ...
    if (poSampleRate->nAdcSampleRate != poSampleRate->nDacSampleRate)
    {
        ...
        if ((poSampleRate->nAdcSampleRate == ADI_SSM2603_SR_48000) &&\
            (poSampleRate->nDacSampleRate == ADI_SSM2603_SR_8000))
        {
            /* SR Field value = 1 */
            nIndexSRValue = 0x01U;
        }
        /* ELSE IF (ADC Sample Rate = 8kHz & DAC Sample Rate = 48kHz) */
        else if ((poSampleRate->nAdcSampleRate == ADI_SSM2603_SR_8000) &&\
                 (poSampleRate->nDacSampleRate == ADI_SSM2603_SR_48000))
        {
            /* SR Field value = 2 */
            nIndexSRValue = 0x02U;
        }
        /* ELSE IF (ADC Sample Rate = 44.1kHz & DAC Sample Rate = 8.02kHz) */
        else if ((poSampleRate->nAdcSampleRate == ADI_SSM2603_SR_44100) &&\
                 (poSampleRate->nDacSampleRate == ADI_SSM2603_SR_8020))
        {
            /* SR Field value = 9 */
            nIndexSRValue = 0x09U;
        }
        /* ELSE IF (ADC Sample Rate = 8.02kHz & DAC Sample Rate = 44.1kHz) */
        else if ((poSampleRate->nAdcSampleRate == ADI_SSM2603_SR_8020) &&\
                 (poSampleRate->nDacSampleRate == ADI_SSM2603_SR_44100))
        {
            /* SR Field value = A */
            nIndexSRValue = 0x0AU;
        }
        ...
        {
            /* Report error */
            nResult = ADI_SSM2603_RESULT_SAMPLE_RATE_NOT_SUPPORTED;
        }
    }
    ...
    else
    {
        ...
        if (nResult == ADI_DEV_RESULT_SUCCESS)
        {
            ...
            /* IF (USB mode enabled) */
            if (nRegData & SSM2603_RFLD_ENABLE_USB_MODE)
            {
                /* Clear BOSR bit */
                nRegData &= ~SSM2603_RFLD_BOS_RATE;

                /* IF (Sample rate is set to 12kHz) */
                if (poSampleRate->nAdcSampleRate == ADI_SSM2603_SR_12000)
                {
                    /* SR value must be set to 8 */
                    nIndexSRValue = 0x08U;
                }
                /* ELSE IF (Sample rate is set to 16kHz) */
                else if (poSampleRate->nAdcSampleRate == ADI_SSM2603_SR_16000)
                {
    ...
    {
        /* Clear SR field */
        nRegData &= ~SSM2603_RFLD_SAMPLE_RATE;
        /* 'nIndexSRValue' holds the new SR value, update SR field */
        nRegData |= (nIndexSRValue << ADI_SSM2603_SHIFT_SR);
        ...
        **********************************************/
        /* Shift the register address
           (Bit 15 to Bit 9 in SSM2603 write packet holds the
            register address to configure) */
        oAccessSSM2603.Address = (SSM2603_REG_SAMPLING_CTRL << ADI_SSM2603_REG_ADDR_SHIFT);
        /* Bit 8 to Bit 0 in SSM2603 write packet holds the register data */
        oAccessSSM2603.Address |= nRegData;
        /* update SSM2603 Sampling Control register */
        nResult = adi_ssm2603_DeviceAccess(poDevice,&oAccessSSM2603);
...
/*********************************************************************
    ...
    Function: adi_ssm2603_SportOpen

        Opens SPORT device allocated to SSM2603 Audio Codec

    Parameters:
        poDataPort - Pointer to SSM2603 SPORT Data port to open
...
)
{
    ...
    if (nResult == ADI_DEV_RESULT_SUCCESS)
    {
        ...
        if (poDataPort->eDirection == ADI_DEV_DIRECTION_BIDIRECTIONAL)
        {
            ...
            gaoSSM2603Device[poDataPort->nAudioDevNumber].oAudioRx.hSport = poDataPort->hSport;
        }
    }
...
/*********************************************************************
    ...
    Function: adi_ssm2603_ConfigSport

        Configures SPORT device registers as per SSM2603 operating conditions

    Parameters:
        poDevice    - Pointer to SSM2603 device instace to work on
        poDataPort  - Pointer to SSM2603 SPORT Data port to configure
...
)
{
    ...
    /* Extract SSM2603 audio data interface format */
    eInterfaceFormat = (poDevice->anSSM2603Reg[SSM2603_REG_DIGITAL_IFACE] & SSM2603_RFLD_IFACE_FORMAT);
    ...
    if (poDataPort->bIsAutoSportConfigEnabled == true)
    {
        ...
        /* IF (SSM2603 is set in Left Justified or I2S Mode) */
        if ((eInterfaceFormat == SSM2603_STEREO_MODE_LJ) ||\
            (eInterfaceFormat == SSM2603_STEREO_MODE_I2S))
        {
        ...
        } /* End of if (SSM2603 is set in Left Justified or I2S Mode) */
...
/*********************************************************************
    ...
    Function: adi_ssm2603_SportCallback

        Callback from the SPORT Driver

    Parameters:
        hCallback   - Callback Handle passed by SSM2603
...
)
{
    ...
    /* Pointer to SSM2603 device SPORT instance to which the callback belongs */
    ADI_SSM2603_DRIVER_DATA_PORT_INFO  *poDataPort = (ADI_SSM2603_DRIVER_DATA_PORT_INFO *)hCallback;

/* for Debug build only - check for errors if required  */
#if defined(ADI_DEV_DEBUG)
    /* IF (The given Physical Device Handle is valid) */
    if (adi_ssm2603_ValidatePDDHandle(hCallback) == ADI_DEV_RESULT_SUCCESS)
    {
#endif

        /* Pass the callback to the Device Manager Callback */
        (gaoSSM2603Device[poDataPort->nAudioDevNumber].pfCallback) (poDataPort->hDevice, nEvent, pArgument);
...
/*********************************************************************
    ...
    Function: adi_ssm2603_ValidateRegAccess
    ...
    switch (nCommandID)
    {
        ...
        case ADI_DEV_CMD_REGISTER_TABLE_READ:
            ...
            while (poSelectiveAccess->Address != ADI_DEV_REGEND)
            {
                ...
                if ((poSelectiveAccess->Address == SSM2603_REG_ACTIVE_CTRL) ||
                    (poSelectiveAccess->Address == SSM2603_REG_RESET) ||
                    (poSelectiveAccess->Address > SSM2603_REG_NOISE_GATE))
                {
        ...
        case ADI_DEV_CMD_REGISTER_TABLE_WRITE:
            ...
            {
                /* IF (the register address is not valid) */
                if (poSelectiveAccess->Address > SSM2603_REG_NOISE_GATE)
                {
                    /* report error (Invalid register) */
                    nResult = ADI_DEV_RESULT_INVALID_REG_ADDRESS;
                    break;
        ...
        case ADI_DEV_CMD_REGISTER_FIELD_TABLE_READ:
            ...
            while (poFieldAccess->Address != ADI_DEV_REGEND)
            {
                ...
                /* IF (the register address is not valid) */
                if (poFieldAccess->Address > SSM2603_REG_NOISE_GATE)
                {
                    /* report error (Invalid register) */
                    nResult = ADI_DEV_RESULT_INVALID_REG_ADDRESS;
                    break;
        ...
        case(ADI_DEV_CMD_REGISTER_BLOCK_READ):
            ...
            if (poBlockAccess->Count)
            {
                ...
                if (poBlockAccess->Address == SSM2603_REG_RESET)
                {
                    /* report error (function not supported) */
                    nResult = ADI_DEV_RESULT_NOT_SUPPORTED;
                    break;
                ...
                if ((poBlockAccess->Address+(poBlockAccess->Count-1)) > (SSM2603_REG_ACTIVE_CTRL+3))
                {
                    /* report error (Invalid register) */
                    nResult = ADI_DEV_RESULT_INVALID_REG_ADDRESS;
                    break;
        ...
        case(ADI_DEV_CMD_REGISTER_BLOCK_WRITE):
            ...
            if (poBlockAccess->Count)
            {
                ...
                if ((poBlockAccess->Address+(poBlockAccess->Count-1)) > (SSM2603_REG_ACTIVE_CTRL+4))
                {
                    /* report error (Invalid register) */
                    nResult = ADI_DEV_RESULT_INVALID_REG_ADDRESS;
                    break;
...
/*********************************************************************
    ...
    Function: adi_ssm2603_ValidatePDDHandle
...
)
{
    ...
    for (nIndex = 0; nIndex < ADI_SSM2603_NUM_DEVICES; nIndex++)
    {
        if ((hPhysicalDevice == (ADI_DEV_PDD_HANDLE)&gaoSSM2603Device[nIndex].oAudioTx) ||\
            (hPhysicalDevice == (ADI_DEV_PDD_HANDLE)&gaoSSM2603Device[nIndex].oAudioRx))
        {
