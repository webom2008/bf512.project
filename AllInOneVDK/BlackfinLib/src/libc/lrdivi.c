 ...
 *************************************************************************/
    ...
    Function: lrdivi - divide a long int by a long int to give a long
                       fract result
    ...
    Description:
        ...
        long integer argument to produce a long fract result. The result
...
#pragma file_attr("libFunc=_lrdivi")
       ...
       long int _divisor) 
{
    ...
    if ((dividend != 0) && (divisor != 0))
    {
        ...
        */
        ...
        uint_ulr_t result_bits_minus_1 = (uint_ulr_t)LFRACT_FBIT;
        ...
        */
        ...
        {
            /* and convert to long fract. */
            result = lrbits((int_lr_t)i_result);
            if (negate)
            {
                result = -result;
            }
