 ...
 *************************************************************************/
    ...
    Function: ulkdivi - divide an unsigned long int by an unsigned long int
                        to give an unsigned long accum result

    Synopsis:

        unsigned long accum ulkdivi (unsigned long int dividend,
                                     unsigned long int divisor);

    Description:
 
        This function divides an unsigned long integer argument by an unsigned
        long integer argument to produce an unsigned long accum result. The
    ...
    Error Conditions:
        ...
        If the result overflows the unsigned long accum size, the value is
        saturated to unsigned long accum.
    ...
    Example:
        ...
        unsigned long int divisor;
        unsigned long accum result;
  
        result = ulkdivi (dividend,divisor);
...
#pragma file_attr("libFunc=ulkdivi")
#pragma file_attr("libFunc=_ulkdivi")
...
ulkdivi(unsigned long int _dividend,
        unsigned long int _divisor) 
{
    ...
    unsigned long accum result = 0.0ulk;
    ...
    if ((dividend != 0U) && (divisor != 0U))
    {
        ...
        unsigned int fract_bits = (unsigned int)ULACCUM_FBIT;
        ...
        uint_uk_t result_bits_minus_1 = (uint_uk_t)ULACCUM_FBIT
                                      + (uint_uk_t)ULACCUM_IBIT - 1U;
        ...
        */
        ...
        unsigned long accum rnd_inc = 0.0ulk;
        ...
        */
        ...
        {
            /* and convert to unsigned long accum. */
            result = ulkbits(i_result);
        }
        result += rnd_inc;
    }
    return result;
