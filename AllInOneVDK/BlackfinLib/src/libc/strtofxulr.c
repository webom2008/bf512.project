...
#pragma file_attr ("prefersMemNum=70")
    ...
    Function: strtofxulr - parse a string representing an unsigned long fract
    ...
    Description:
        ...
        characters as an unsigned long fract value. If successful, this value
    ...
    Example:
        ...
        #include <stdfix.h>
        char *my_string = " 0.5 is an unsigned long fract value";
        char **tail;
        unsigned long fract result;

        result = strtofxulr (my_string,tail);

***************************************************************************
#endif

#define __DISABLE_STRTOFXULR 1
#include <stdfix.h>
#include <stdbool.h>
...
unsigned long fract 
strtofxulr(const char * __restrict _nptr,
           char ** __restrict _endptr)
{
    ...
    */
    ...
    return ulrbits((uint_ulr_t)result_i);
}
