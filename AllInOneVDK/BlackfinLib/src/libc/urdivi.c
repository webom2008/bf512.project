 ...
 *************************************************************************/
    ...
    Description:
        ...
        integer argument to produce an unsigned fract result. The result
       ...
       unsigned int _divisor) 
{
    ...
    if ((dividend != 0U) && (divisor != 0U))
    {
        ...
        uint_ur_t result_bits_minus_1 = (uint_ur_t)UFRACT_FBIT - 1U;
