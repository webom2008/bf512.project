...
/*
   WARNING : A lot of uCOS data structures will vary size
             depending on the size of this configuration
             in order to create the bigger one, the OS_LOWEST_PRIO
             need to be set to greater than 63.
             If this is not done, there is a risk of data overwrite because
             the OSAL will allocate sizes for data structures that is too small
*/                                  
#define OS_LOWEST_PRIO          250    /* Defines the lowest priority that can be assigned ...         */
