...
/*
 * Clock Settings :VCO=264MHz,CCLK=264MHz,SCLK=132MHz
...
#define CONFIG_EBIU_SDRRC_VAL	0x0805 //SDRAM Refresh Rate Control Register
...
#define CONFIG_SYS_LOAD_ADDR            0x00800000 //SDRAM BANK2 START ADDR
...
#define CONFIG_SPI_FLASH_GIGADEVICE     //-QWB20140213- PM.AIO
...
#define CONFIG_USER_SPI_FLASH_SIZE      ((unsigned long)(CONFIG_SPI_FLASH_SIZE - CONFIG_UBOOT_SPI_FLASH_SIZE))
